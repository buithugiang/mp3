...
function getQuantityValueAndUnit(ob) {
  if (typeof ob != 'undefined' &&
    ...
    console.log(ob.valueQuantity.unit);
    console.log(ob.valueQuantity.value);
    console.log(ob.valueQuantity);
...
function displayObservation(obs) {
  ...
  hscrp.innerHTML = obs.weight;
  chol.innerHTML = obs.height;
...
function addWeightAnnotation() {
  var annotation = "No annotation"
  var authorString = "gbui8"
  var currentdate = new Date();
  var currenttime = currentdate.toISOString();
  // displayAnnotation(annotation);
  console.log(we);
  if (typeof we.note != 'undefined'){
  annotation = "";
  annotation += " author: " + we.note[0].authorString + " ; ";
  annotation += " text: " + document.getElementById('annotation').value + " ; ";
  annotation += " date: " + we.note[0].time + "";
   displayAnnotation(annotation);
 }
